      ...
      <aside className="w-64 border-r border-white/10 flex flex-col bg-[#0a0a0a] shrink-0">
        ...
        <div className="px-5 py-5 border-b border-white/10">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 rounded-lg bg-[#D85A30] flex items-center justify-center group-hover:bg-[#B84820] transition-colors">
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  isActive
                    ? "bg-[#D85A30]/15 text-[#D85A30] border border-[#D85A30]/20"
