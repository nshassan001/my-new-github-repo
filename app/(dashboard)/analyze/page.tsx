  ...
  return (
    <div
      className={clsx(
        ...
        gradeColors[grade] || "bg-brand/15 text-brand border-brand/30"
      )}
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="card space-y-5">
          <h2 className="text-base font-semibold text-white/80 flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-brand/20 text-brand text-xs flex items-center justify-center font-bold">1</span>
            Core Metadata
          </h2>
          ...
          <div>
            <label className="label">
              Target Keyword <span className="text-brand">*</span>
            </label>
            <input
              type="text"
              value={input.keyword || ""}
        ...
        <section className="card space-y-4">
          <h2 className="text-base font-semibold text-white/80 flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-brand/20 text-brand text-xs flex items-center justify-center font-bold">2</span>
            Description
          </h2>
          <div>
        ...
        <section className="card space-y-4">
          <h2 className="text-base font-semibold text-white/80 flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-brand/20 text-brand text-xs flex items-center justify-center font-bold">3</span>
            Transcript
          </h2>
          <div>
        ...
        <section className="card space-y-4">
          <h2 className="text-base font-semibold text-white/80 flex items-center gap-2">
            <span className="w-6 h-6 rounded-md bg-brand/20 text-brand text-xs flex items-center justify-center font-bold">4</span>
            Tags
          </h2>
          <div>
        ...
        <section className="card space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-semibold text-white/80 flex items-center gap-2">
              <span className="w-6 h-6 rounded-md bg-brand/20 text-brand text-xs flex items-center justify-center font-bold">5</span>
              SEO Checklist
            </h2>
            ...
            {CHECKLIST_ITEMS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="ml-auto text-xs text-brand/60 font-mono shrink-0">
                    +{item.points}
                  </span>
                </label>
              );
